...
namespace ESG.Views
{
    ...
    /// </summary>
    public partial class EditReportWindow : Window, INotifyPropertyChanged
    {
        ...
        public EditReportWindow(Report report)
        {
            InitializeComponent();
            _report = report;
            ...
            if (scrollViewer != null)
            {
                ...
                // Инициализируем IsSelected для текущей компании
                var currentCompany = _companies.FirstOrDefault(c => c.CompanyId == _report.CompanyId);
                if (currentCompany != null)
                {
                    currentCompany.IsSelected = true;
                }
                // Инициализируем выбранный год
                if (_report.Year.HasValue)
                {
                    SelectedYear = _years.FirstOrDefault(y => y.Year == _report.Year.Value);
                }
            }
        }
